...
@interface __MKUI_UITableViewDefaultSectionView : UIView
MKAS_SINGLETON(__MKUI_UITableViewDefaultSectionView)
@property(nonatomic,strong) NSString *title;
@property(nonatomic,strong) UILabel *titleLabel;
+ (UIEdgeInsets)contentInsets;
@end
@implementation __MKUI_UITableViewDefaultSectionView
MKDEF_SINGLETON(__MKUI_UITableViewDefaultSectionView)
...
@end
@interface __MKUI_UITableViewDefaultGroupHeadSectionView : __MKUI_UITableViewDefaultSectionView
@end
@implementation __MKUI_UITableViewDefaultGroupHeadSectionView
MKDEF_SINGLETON(__MKUI_UITableViewDefaultGroupHeadSectionView)
@end
@interface __MKUI_UITableViewDefaultGroupFootSectionView : __MKUI_UITableViewDefaultSectionView
@end
@implementation __MKUI_UITableViewDefaultGroupFootSectionView
MKDEF_SINGLETON(__MKUI_UITableViewDefaultGroupFootSectionView)
+ (UIEdgeInsets)contentInsets{
    ...
    if(sectionHeight==UITableViewAutomaticDimension){
        ...
        if(!sectionView){
            if(self.style==UITableViewStylePlain){
                ...
                NSString *title = nil;
                __MKUI_UITableViewDefaultSectionView *v = nil;
                if(isHeader){
                    ...
                    v = [__MKUI_UITableViewDefaultGroupHeadSectionView sharedInstance];
                }else{
                    ...
                    v = [__MKUI_UITableViewDefaultGroupFootSectionView sharedInstance];
                }
                v.title = title;
                sectionView = v;
            }
